            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                 ...
                 <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        <input type="checkbox" value='16' name='name1[]' class="form-control" id='refe'>
                    </div>
                </div>
                 <div class="col-sm-2">
                    <div class="form-group">
                 ...
                 <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        <input type="checkbox" value='19' name='name1[]' class="form-control" id='refr'>
                    </div>
                </div>
                 <div class="col-sm-2">
                    <div class="form-group">
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        <input type="checkbox" value='22' name='name1[]' class="form-control" id='refq'>
                    </div>
                </div>
                 <div class="col-sm-2">
                    <div class="form-group">
                        <label for="usr">24:</label>
                        <input type="checkbox" value='24' name='name1[]' class="form-control" id='rev3'>
                    </div>
                </div>
                 <div class="col-sm-2">
                    <div class="form-group">
                        <label for="usr">26:</label>
                        <input type="checkbox" value='26' name='name1[]' class="form-control" id='refw'>
                    </div>
                </div>
                 <div class="col-sm-2">
                    <div class="form-group">
                        <label for="usr">27:</label>
                        <input type="checkbox" value='27' name='name1[]' class="form-control" id='rev4'>
                    </div>
                </div>
                 <div class="col-sm-2">
                    <div class="form-group">
                        <label for="usr">29:</label>
                        <input type="checkbox" value='29' name='name1[]' class="form-control" id='refx'>
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group">
                        <label for="usr">31:</label>
                        <input type="checkbox" value='31' name='name1[]' class="form-control" id='rev5'>
                    </div>
                </div>
...
document.getElementById("refw").onclick = function() {ref();};
document.getElementById("refx").onclick = function() {ref();};
document.getElementById("refe").onclick = function() {ref();};
document.getElementById("refr").onclick = function() {ref();};
document.getElementById("refq").onclick = function() {ref();};
document.getElementById("ref").onclick = function() {ref();};
